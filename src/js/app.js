       ...
       link: function(scope, elem, attrs) {
	       	scope.$watch('data', function(newData) {
	            ...
	            var data = scope[attrs.chartData],
						...
						//
						ringNum = 9,
						vertPlacement = 2.3;  // hight given chart's shape
						...
						vis.append('svg:g')
						    ...
						    .enter().append('line')
							    ...
							    .attr('x1', function(d, i) { 
							    	return radius * x(1609.34 * 2) * Math.sin(angle * i) / 2;
							    })
							    .attr('y1', function(d, i) { 
							    	return radius * y(1609.34 * 2) * Math.cos(angle * i) / 2 * -1;
							    })
						...
						vis
						  ...
						  .enter().append('svg:circle')
						    ...
						    // .attr('fill', '#7545E6')
						    // .attr('stroke', 'rgba(255, 255, 255, .17)')
						    // .attr('stroke', '#020722')
						    // .attr('stroke-width', 2)
						    .transition()
							    // .duration(500)
